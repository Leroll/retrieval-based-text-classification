...
logger.info(f"Number of GPUs available: {number_of_gpu}")

# load tokenizer and model
tokenizer = AutoTokenizer.from_pretrained(reranker_model_name)
model = LLM(model=reranker_model_name, tensor_parallel_size=number_of_gpu, max_model_len=10000, enable_prefix_caching=True, gpu_memory_utilization=0.8)
...
#   python examples/qwen3_reranker_test.py
#-----------------------------------
